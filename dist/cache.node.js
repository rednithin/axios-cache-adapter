...
function setupCache() {
  ...
  function _adapter() {
    _adapter = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req) {
      var reqConfig, res, next, forceFetch, networkError, readOnError;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              res = _context2.sent;
              next = res.next;
              forceFetch = res.forceFetch; // Response is not function, something was in cache, return it
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        ...
                        case 3:
                          _res = _context.sent;
                          forceFetch === null || forceFetch === void 0 ? void 0 : forceFetch(_res);
                          _context.next = 10;
                          break;
